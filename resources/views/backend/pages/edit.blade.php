      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{route('pages.update',['id' => $page->id])}}">
              {!! csrf_field() !!}
              {{ method_field('PATCH') }}
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <textarea id="long_desc" name="long_desc" rows="10" cols="80">{{$page->long_desc}}</textarea>
                    </div>
                  </div>
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    <div class="checkbox">
                      <label>
                        {{ Form::checkbox('active', '1', ($page->active===1 ?true:false)) }} เปิดใช้งาน
                      </label>
                    </div>
                  </div>
                </div>
